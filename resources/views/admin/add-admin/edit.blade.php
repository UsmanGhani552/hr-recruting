		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="outbox">
					...
					<form method="POST" action="{{route('add-admin.update' , $addAdmin->id)}}">
                        @csrf
					    <div class="row">
							...
							<div class="col-md-12">
								<label class="form-group">
                                    Name
                                    <input type="text" name="name" class="form-controll"  value="{{ old('name',$addAdmin->name) }}"
                                        placeholder="Name">
                                        @error('name')
							...
							<div class="col-md-12">
								<label class="form-group">
                                    Email
                                    <input type="text" name="email" class="form-controll" value="{{ old('email',$addAdmin->email) }}"
                            ...
                            <div class="col-md-6">
                                <label class="form-group" for="email">
                                    ...
                                    <input id="password" type="password" placeholder="Enter Password"
                                        class="form-controll" name="password" value="{{ old('password') }}">
                                    ...
                                    @foreach ($roles as $role)
                                        <div class="mb-10 fv-row">
                                            <div class="form-check form-check-custom form-check-solid">
                                                ...
                                                @if(count($addAdmin->roles->where('id',$role->id)))
                                                checked
                                                @endif
                                                />
